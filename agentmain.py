...
class GenericAgent:
    def __init__(self):
        ...
        self.work_dir = os.path.join(script_dir, 'temp')  # tool cwd; frontends may bind a session to a project folder
    ...
    def run(self):
        while True:
            ...
            handler = GenericAgentHandler(self, self.history, self.work_dir)
